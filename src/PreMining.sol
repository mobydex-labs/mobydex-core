...
contract PreMining is Ownable {
    ...
    uint256 public endTime = type(uint256).max;
    ...
    constructor(IERC20 _reward, uint256 _rewardPerSec) {
        reward = _reward; //esMOBY
