...
contract MOBYSale is ReentrancyGuard {
    ...
    // The tiemstamp when sale starts
    uint256 public startTime;
    // The tiemstamp when sale ends
    ...
    function initialize(
        ...
        IERC20 _offeringToken, // MOBYDEX TOKEN
        uint256 _startTime, //
        uint256 _endTime,
    ...
    // get the amount of moby token you will get
